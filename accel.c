...
static void accel_motion_init() {
	...
	//0x18 FF_MT_COUNT
	accel_write_register(0x18, 0x08);
}
...
static void accel_pulse_init() {
	...
	accel_write_register(0x21, 0x70);
