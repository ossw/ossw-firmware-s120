...
#define SCR_EVENT_PARAM_BUTTON_UP      0x00
#define SCR_EVENT_PARAM_BUTTON_DOWN    0x01
#define SCR_EVENT_PARAM_BUTTON_SELECT  0x02
#define SCR_EVENT_PARAM_BUTTON_BACK    0x03
